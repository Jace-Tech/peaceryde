  ...
  <main class="new new-main layout">
    ...
    <section class=" new-section2__group layout2 nbvformheight" style="background-color: #f8f6f6;">
      <div class="new-section1__cover-block layout signinpage">
        ...
        <p class="formtext">The first step in applying for a <span style="font-size: 20px; font-weight: 500;">Nigeria Temporary Work Permit</span> is to fill the form below.<br>
                  ...
                  <div class="row">
                    ...
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <select name="countryCode" id="" required name="country_code" aria-label="Default select example" class="form-select code"
