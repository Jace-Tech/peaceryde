                    ...
                    <form>
                        <div class="form-row rpml">
                          <div class="form-group inputdiv">
                            <p class="fpp">Old Password</p>
                            <input type="text" class="form-control rpinput" placeholder="" style="margin-top: 6px;"/>


                            <p class="fpp" style="padding-top: 27px;">New Password</p>
                            <input type="text" class="form-control rpinput" style="margin-top: 6px;" placeholder=""/>                            
                            </div>
                        </div>
                       <div class="row buttonrow">
                           ...
                           <div class="col-md-6 col-sm-12">
                            <div class="rpmb">
                                <button type="submit" class="btn proceed rpbutton">Create Password</button>
                            </div>
                           </div>
                       </div>
