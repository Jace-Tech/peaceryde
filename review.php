                    ...
                    <div class="card reviewcard">
                        <div class="reviewml">
                            <div class="form-group4 reviewmt">
                                <div class="row">
                                    <div class="col-md-1">
                                        <img src="assets/7816017df0b1e40af0ec9a619518086f.png" style="border-radius: 50%; margin-bottom: 14px;" width="50">
                                    </div>
                                    <div class="col-md-10">
                                        <p class="reviewname">Anny Jones</p>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                <p><span><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div style="margin-bottom: 59px; margin-top: 17px;">
                                    ...
                                    <p class="reviewtext"> When Applying for my Business Visa On Arrival I only realised then all the various paperwork to fill out and documents required. It was quite confusing. I was referred to PeaceRyde Africa and within a day or two of contacting PeaceRyde Africa, I had started my application, PeaceRyde Africa submitted my application on the 2nd of March and I got my application approved on the 1st of may so in just 2 months they got everything sorted for me. They were always there to answer any questions and provided me with all the documents required and offered continuous guidance through the process</p>
                                </div>
                            </div>
                        </div>
                    </div>
