...
<head>
    <meta charset="utf-8" />
    <title>PeaceRyde Africa LLC - Review</title>
    ...
    <main class="new new-main layout">
        ...
        <section class=" new-section2__group layout2 reviewheight" style="background-color: #f8f6f6;">
            <div class="new-section1__cover-block layout signinpage">
                ...
                <h1 class="whoweare" style="margin-top:100px; margin-left:0px; text-align:center">
                    Reviews
                </h1>
                                                    ...
                                                    <div class="col-md-6" style="margin-left: -35px;">
                                                        <div class="rate">
                                                            <?php for ($i = 0; $i < intval($review['rating']); $i++) : ?>
                                                                <span class="text-2xl fa fa-star checked" data-rating="<?= $i + 1 ?>"></span>
                                                            <?php endfor; ?>

                                                            <?php for ($i = 0; $i < (5 - intval($review['rating'])); $i++) : ?>
                                                                <span class="text-2xl fa fa-star-o" data-rating="<?= intval($review['rating']) + ($i + 1) ?>"></span>
                                                            <?php endfor; ?>
                                                        </div>
