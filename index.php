                    ...
                    <div class="row" style="background-color: #E6F5EE;">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="new-section7__cover-group layout">
                                <div style="background-image:url(assets/smbg.png); background-size: cover;" class="new-section7__cover1 layout">
                                </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6 div4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-xs-6 company">
                                                ...
                                                <ul>
                                                    <li class="new-section8__text-body5 layout fs-13"><a class="fs-13" href="about.php" style=" text-decoration: none;">About
                                                            us</a>
                                                    </li>
                                                    <li class="new-section8__text-body5 layout fs-13"><a class="fs-13" href="pp.php" style=" text-decoration: none;">Privacy
                                                            &Cookie Policy</a>
                                                    </li>
                                            ...
                                            <div class="mainchat">
                                                ...
                                                <div class="px-2 scroll">
                                                    <div class="d-flex align-items-center">
                                                        <div class="text-left pr-1"><img src="https://img.icons8.com/color/40/000000/guest-female.png" width="30" class="img9" />
                                                        </div>
