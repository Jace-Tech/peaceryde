            ...
            <div class="movement">
                    ...
                    <div class="new-section2__flex-item col-md-4 col-sm-4 col-lg-4">
                        <div class="new-section2__block12 layout">
                            <div class="new-section2__flex6 layout">
                                ...
                                <div
                                    style=" border-top: 1px solid #000080; height: 1px; margin-top: 10px; margin-bottom: 25px;">
                                </div>
                ...
                justify-content: center;">
                                ...
                                <div class="new-section2__paragraph-body1-box layout">
                                    <pre
                                        class="new-section2__paragraph-body1">VOA is required for persons of legal age intending to come to Nigeria for business, and pleasure. The VOA immigration approval is needed for visa issuance in Nigeria.</pre>
                                </div>
                    ...
                    <div class="new-section2__flex-item col-md-4 col-sm-4 col-lg-4">
                        <div class="new-section2__block12 layout">
                            <div class="new-section2__flex6 layout">
                                ...
                                <div
                                    style=" border-top: 1px solid #060a5c; height: 1px; margin-top: 10px; margin-bottom: 25px;">
                                </div>
                                <!-- <hr style="border: 1px solid #060a5c; "> -->
                                <div style="display: flex;
                justify-content: center;">
                                ...
                                <div class="new-section2__paragraph-body1-box layout">
                                    <pre
                                        class="new-section2__paragraph-body1">TWP is required for persons of legal age intending to work in Nigeria. The TWP immigration approval is a prerequisite for issuance of a TWP visa in a Nigerian embassy abroad.</pre>
                                </div>
                ...
                justify-content: center;">
                                ...
                                <div class="new-section2__paragraph-body1-box layout">
                                    <pre
                                        class="new-section2__paragraph-body1">This is applicable to anyone of legal age intending to register a business in Nigeria.</pre>
                                </div>
                    ...
                    <div class="get">
                        <div class="new-section5__flex3-item">
                            <div class="new-section5__content-box1 layout cardwidth">
                                ...
                                <svg width="90" height="89" class="cardimg" viewBox="0 0 90 89" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M89.4344 44.5C89.4344 69.0767 69.4138 89 44.7172 89C20.0206 89 0 69.0767 0 44.5C0 19.9233 20.0206 0 44.7172 0C69.4138 0 89.4344 19.9233 89.4344 44.5Z"
                                        fill="#F1F5F6" />
                                    <path
                                        d="M52.6508 50.1626H56.1392V53.6509H52.6508V50.1626ZM52.6508 43.1859H56.1392V46.6742H52.6508V43.1859ZM52.6508 36.2092H56.1392V39.6976H52.6508V36.2092ZM46.9648 36.2092L49.1625 37.6743V36.2092H46.9648Z"
                                        fill="#0A0E69" />
                                    <path
                                        d="M40.4417 29.2324V31.8661L43.93 34.1859V32.7208H59.6275V57.1391H52.6508V60.6274H63.1158V29.2324H40.4417Z"
                                        fill="#0A0E69" />
                                    <path
                                        d="M37.2498 33.9417L49.1625 41.8776V60.6274H24.7441V42.2788L37.2498 33.9417ZM40.4416 57.1391H45.6741V43.4648L37.2498 38.1102L28.2325 43.8485V57.1391H33.465V46.6741H40.4416V57.1391Z"
                                        fill="#0A0E69" />
                                    <path opacity="0.3"
                                        d="M40.4417 57.1392H45.6742V43.4649L37.2499 38.1104L28.2325 43.8487V57.1392H33.465V46.6742H40.4417V57.1392Z"
                                        fill="#0A0E69" />
                                </svg>
                    ...
                    <div class="col-md-2 mag">
                        <div>
                            <img src="assets/567e56d659b95feb61c2ad9900beb3a7.png" width="50" class="rounded-circle"
                                style="margin-left: 65px; margin-bottom: 13px;">
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit.  </pre>
                ...
                <button class="btn btn-review"
                    style="border: 1px solid #a0bd1c;  background-color: transparent; color: #a0bd1c;">See More
                    Reviews</button>
                    ...
                    <div class="row" style="background-color: #E6F5EE;">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="new-section7__cover-group layout">
                                <div style="background-image:url(assets/smbg.png); background-size: cover;"
                                    class="new-section7__cover1 layout">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-6 col-xs-6">
                                        <div class="new-section8__block20 layout">
                                            ...
                                            <ul>
                                                <li class="lg-li"><svg width="16" height="16" viewBox="0 0 16 16"
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6 div4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-xs-6 company">
                                                ...
                                                <ul>
                                                    <li class="new-section8__text-body5 layout fs-13"><a class="fs-13"
                                                            href="about.php" style=" text-decoration: none;">About
                                                            us</a>
                                                    </li>
                                                    <li class="new-section8__text-body5 layout fs-13"><a class="fs-13"
                                                            href="pp.php" style=" text-decoration: none;">Privacy
                                                            &Cookie Policy</a>
                                                    </li>
                                                    <li class="new-section8__text-body5 layout fs-13" 0><a
                                                            href="t&c.php" class="fs-13"
                ...
                z-index: 5;" class="btn btn-sm btn-primary" onclick="openForm()">
                                ...
                                <div class="chat-popup" id="myForm">
                                    <form action="/action_page.php" class="form-container">
                                        <div class="wrapper">
                                            <div class="mainchat">
                                                <button type="button" class="btn cancel" style="margin-left: 280px;"
                                                ...
                                                <div class="px-2 scroll">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="pr-2 pl-1"> <span class="name">Sarah Anderson</span>
                                                            <p class="msg">Hi Dr. Hendrikson, I haven't been falling
                                                                well for past few days.</p>
                                                        </div>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div><img src="https://i.imgur.com/HpF4BFG.jpg" width="30"
                                                                class="img9" /></div>
                                                    </div>
                                                ...
                                                <nav
                                                    class="navbars bg-white navbar-expand-sm d-flex justify-content-between">
                                                    <input type="text number" name="text" class="form-controls"
                                                        placeholder="Type a message...">
                                                    <div
                                                        class=" d-flex justify-content-end align-content-center text-center ml-2">
                                                        <svg width="33" height="35" viewBox="0 0 33 35" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M32.4419 20.4722C32.5822 19.2858 32.0534 18.1264 31.0686 17.4434L8.12261 1.50404C7.09665 0.772938 5.80289 0.713532 4.70133 1.30734C3.57966 1.91099 2.86538 3.55356 3.029 4.81133L4.30132 14.5749C4.43205 15.5761 5.23388 16.3557 6.23997 16.4571L19.7964 17.8394C20.4918 17.8985 20.9955 18.5204 20.9086 19.213C20.8348 19.8949 20.222 20.3912 19.5266 20.3321L5.95836 18.9379C4.95253 18.8342 4.00153 19.4326 3.65928 20.3856L0.300426 29.7007C-0.10413 30.8007 0.103129 31.9631 0.816651 32.8442C0.900595 32.9479 0.995031 33.0645 1.09201 33.1576C2.04085 34.0627 3.38245 34.3065 4.60167 33.8126L30.4291 23.1319C31.5361 22.6861 32.3016 21.6586 32.4419 20.4722Z"
                                                                fill="#1161D9" />
                                                        </svg>
                                                    </div>
                                                </nav>
