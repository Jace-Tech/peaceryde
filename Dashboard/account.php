                ...
                <form>
                  ...
                  <div class="form-row accountrow">
                    <div class="form-group">                   
                        ...
                        <input type="text" class="form-control accountinput"
                         placeholder="John" >
                    </div>                    
                    <div class="form-group">                   
                    ...
                    <div class="form-group">                   
                        ...
                        <input type="text" class="form-control accountinput" placeholder="johndoe@gmail.com" >
                    </div>    
                    <div class="form-group">                   
                        <p class="accountfirst">Password</p>              
                        <input type="text" class="form-control accountinput" placeholder="********************" >
                    </div>    
                 
                        <div style="margin-top:49px">
                            <button type="submit" class="btn btn-button accountbutton">Update Profile</button>
                        </div>
                </form>         
            </div>               
