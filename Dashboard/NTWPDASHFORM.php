...
<body>
                    ...
                    <form data-form action="../handlers/form_handler.php" method="post">
                        ...
                        <div class="container mt-15">
                            <div class="row formml">
                                <div class="col-md-7">
                                    <select required name="title" class="form-select fmselect" aria-label="Default select example">
                            ...
                            <div class="row formml" style="margin-top:5%">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required id="country" data-length name="country" class="form-select fmselect select" aria-label="Default select example">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <select name="countryCode" id="" required name="country_code" class="form-select" id="inputGroupSelect01" aria-label="Default select example" style="width: 60px;height:43px; background-color: #ADC92E; color: #F9FFFF; font-size:15px; padding-left:0px;">
    ...
    <script>
        ...
        console.log(genders, storedUser);
        ...
        if (storedUser) {
            ...
            if(Array.from(form.elements.title.children).filter(item => item.value == title)[0]) {
