            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="align-self-center">
                        <div class="row">
                            <div class="">
                                <h3 class="page-title text-truncate mb-1 trackh3">My Progress</h3>
                    ...
                    <div class="align-self-center">
                        <div class="customize-input">
                            <ol class="breadcrumb mb-2">
                                <li class="breadcrumb-item"><a href="" style="color: #080C58;margin-top: 1px;"><svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="breadcrumb-item" style="margin-top: 1px;"><a href="javascript:void(0)" style="color: #080C58;"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
