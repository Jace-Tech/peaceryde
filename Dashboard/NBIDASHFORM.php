                          ...
                          <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-prepend">
                                    <select required name="countryCode" class="form-select" id="inputGroupSelect01" style="width: 60px;height:43px; background-color: #ADC92E; color: #F9FFFF; font-size:15px; padding-left:0px;">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row" style="margin-top: 15px;">
                                <div class="col-md-4 col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        <label class="form-label">Date of Birth</label>
                                        <input required type="text" data-date readonly name="dob" value="<?= strstr(strval($USER['date_of_birth']), "0000") ? "" : date("d-m-Y"); ?>" id="datepicker" class="form-control dob" placeholder="dd-mm-yyyy">
                                    </div>
                                </div>
