                                            ...
                                            <?php if (count($USER_MESSAGES)) : ?>
                                                <?php foreach ($USER_MESSAGES as $__message) : ?>
                                                    ...
                                                    <?php if ($__message['attachment']) : ?>
                                                        ...
                                                        <div class="<?= $USER_ID == $__message['sender_id'] ? "chat-message-right" : "chat-message-left" ?> d-flex align-items-center p-1 rounded text-underline mb-2 bg-light g-2" style="max-height: 50px;">
