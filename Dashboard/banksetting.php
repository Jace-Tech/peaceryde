    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper" id="main">
            ...
            <p class="bankdivp">
                ...
                <span style="font-family: Ubuntu;padding-left:32px;color:#ffffff;font-size: 18px;font-style: normal;font-weight: 400;">Add New Debit/ Credit Card</span>
            </p>
            <p style="font-family: Ubuntu;padding-left:255px;color:#ffffff;font-size: 13px;font-style: normal;font-weight: 400;">Tap to Add</p>
