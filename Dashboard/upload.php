    ...
    <div class="page-wrapper" id="main" style="background-color: #e5e5e5;">
      ...
      <form action="./handler/upload_handler.php" method="post" enctype="multipart/form-data">
        <div>
          ...
          <p class="pleaseupload">Upload all relevant documents(example, passport photograph, international passport data page, proof of empowerment, flight itinerary etc), by browsing the "drop file here" link and then click the upload file button</p>
        </div>
