    ...
    <div class="page-wrapper" id="main">
      ...
      <div class="container">
        <div class="card">
          ...
          <form class="formml" method="post" data-form action="./handler/apply_handler.php">
            <div class="form-body">
              ...
              <div class="row" style="margin-top: 25px;">
                <div class="col-md-6 col-lg-5 col-xl-5">
                  <div class="form-group">
                    <input type="text" required name="email" data-length value="<?= $USER['email'] ?? ""; ?>" class="form-control mobileno" placeholder="Email">
                  </div>
                </div>
                <div class="col-md-6 col-lg-5 col-xl-5">
                  <div class="form-group">
