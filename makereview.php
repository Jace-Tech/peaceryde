                        ...
                        <div class="card makereviewcard">
                            ...
                            <fieldset class="rating">
                                <input type="radio" id="star5" name="rating" value="5" /><label class="full" for="star5"
                                    title="Awesome - 5 stars" style="margin-right: 110px;"></label>
                            ...
                            <textarea class="reviewtextarea"
                                placeholder="This is where you write your review.explain what happend, keep your feedback honest, helpfyl, and constructive">

                        </textarea>

                            <nav class=" bg-white navbar-expand-sm d-flex justify-content-between"> <input
                                    type="text number" name="text" class="form-controls"
                                    style="width: 319px; margin-left: 22px; margin-top: 34px; margin-bottom: 38px; border: 1px solid #555555;"
                                    placeholder="Type a message...">
                                <div class=" d-flex justify-content-end align-content-center text-center ml-2"> <svg
                                        width="39" height="41" viewBox="0 0 39 41" fill="none" style="margin-top: 34px;
                                margin-right: 12px;" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="col-md-7 col-sm-6 col-xs-6 company">
                                            ...
                                            <ul>
                                                <li class="new-section8__text-body5 layout fs-13"><a class="fs-13"
                                                        href="about.php" style=" text-decoration: none;">About us</a>
                                                </li>
                                                <li class="new-section8__text-body5 layout fs-13"><a class="fs-13"
                                                        href="pp.php" style=" text-decoration: none;">Privacy &Cookie
                                                        Policy</a>
                                                </li>
