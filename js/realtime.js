    ...
    messageNotificon.innerHTML = `
                ...
                <li class="breadcrumb-item logoutlaptop" style="margin-top: 1px;">
                    <div class=" nav-item dropdown mobilelang" style="margin-top:-29px">
                        ...
                        <li><a class='dropdown-item lang-select' href='#googtrans(en|ig)' data-lang='ig' style='color: black; font-size: 15px; padding-bottom: 10px;'>Igbo</a></li> 
                        ...
                        <li><a class='dropdown-item lang-select' href='#googtrans(en|yo)' data-lang='yo' style='color: black; font-size: 15px; padding-bottom: 10px;'>Yoruba</a></li> 
