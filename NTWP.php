...
<head>
    <meta charset="utf-8" />
    <title>PeaceRyde Africa LLC - NTWP</title>
...
<body style="overflow-x: hidden;">
    <main class="new new-main layout">
        ...
        <section class=" new-section2__group layout2 nbiheight" style="background-color: #f8f6f6;">
          <div class="new-section1__cover-block layout" style="margin-top:65px">
              <h1 style="font-size: 35px; text-align: center; color: #000080; font-family:Ubuntu">
                Nigeria Temporary Work Permit
              </h1>
              <div class="row" style="margin-top:65px">
              
                  <div class="col-md-4 col-xs-12 nbiimage">
                      <img src="assets/image_2022-02-25_06-02-55.png" class="imagebn">
                  </div>
                  
                  <div class="col-md-5 col-xs-12">
                      <p class="nbitext">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                          Imperdiet
                          dolor donec etiam
                      ...
                      ">See More.....</a></p>
                      <a href="./NTWPForm" class="btn buttons3">Apply</a>
