...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>PeaceRyde Africa LLC - Sign up</title>
							...
							<form action="./handler/auth_handler.php" method="post">
								<div class="space-y-4">
									<div>
										...
										<input reqiured name="email" class="form-input w-full" type="email" />
									</div>
									<div>
										<label class="block text-sm font-medium mb-1" for="name">Full Name <span class="text-red-500">*</span></label> 
										<input reqiured name="name" class="form-input w-full" />
									</div>
									<div>
										<label class="block text-sm font-medium mb-1" for="password">Password</label> 
										<input reqiured name="password" class="form-input w-full" type="password" autocomplete="on" />
									</div>
								</div>
								<div class="flex items-center justify-between mt-6">
									<button class="btn bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap" name="register" type="submit">Sign Up</button>
								</div>
							</form>
