                                            ...
                                            <div class="px-5 py-4">
                                                <div class="space-y-3">
                                                    <div><label class="block text-sm font-medium mb-1" for="feedback">Message <span class="text-red-500">*</span></label>
                                                        ...
                                                        <textarea id="feedback" name="message" class="form-textarea w-full px-2 py-1" rows="4" required=""></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="text-sm <?= $theme =  $sender_id === $LOGGED_ADMIN['admin_id'] ? "bg-indigo-500 text-white" : "bg-white text-gray-800" ?> p-3 rounded-lg border border-transparent shadow-md mb-1" style="border-top-right-radius: 0;">
                                            <?php foreach($_attachments as $attachment): ?>
                                                <div class="flex items-center">
                                                    ...
                                                    <a download="<?= $attachment; ?>" href="../attachment/<?= $attachment ?>" class="text-sm <?= $sender_id === $LOGGED_ADMIN['admin_id'] ? "text-gray-200" : "text-gray-500" ?> font-semibold flex-1">
                                                        <?= $attachment ?>
                                                    </a>
                                                </div>
                                            <?php endforeach; ?>
