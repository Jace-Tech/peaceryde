				...
				<div class="w-full md:w-1/2">
					<div class="min-h-screen h-full flex flex-col after:flex-1">
						...
						<div class="max-w-sm mx-auto px-4 py-8">
							<h1 class="text-3xl text-gray-800 font-bold mb-6">Verify Pin ✨</h1>
							<form action="./handler/reset_handler.php" method="post">
								<div class="space-y-4">
									<div>
										<label class="block text-sm font-medium mb-1" for="email">Pin <span class="text-red-500">*</span></label> 
										<input id="email" class="form-input w-full" name="pin" type="text" />
									</div>
								</div>
								<div class="flex justify-end mt-6">
									<button name="verify" type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap">Verify</button>
								</div>
							</form>
						</div>
					</div>
