<?php if(isset($active)): ?>
    <div id="sidebar" class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-gray-800 p-4 transition-all duration-200 ease-in-out" style="background-color: #1161d9;" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-64'" @click.outside="sidebarOpen = false" @keydown.escape.window="sidebarOpen = false" x-cloak="lg" style="overflow-x: hidden;">
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <!-- <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" x-data="{ open: false }">
                            <a class="sidebar-expander-link block text-gray-50 hover:text-white transition duration-150" :class="open && 'hover:text-gray-100'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="{ 'hidden': !open }" x-cloak>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="signin.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sign In</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="signup.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sign up</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="reset-password.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Reset Password</span></a></li>
                                </ul>
                            </div>
                        </li> -->
                        <!-- <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" x-data="{ open: false }"><a class="sidebar-expander-link block text-gray-50 hover:text-white transition duration-150" :class="open && 'hover:text-gray-100'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="{ 'hidden': !open }" x-cloak>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="onboarding-01.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 1</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="onboarding-02.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 2</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="onboarding-03.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 3</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" href="onboarding-04.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 4</span></a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="{ 'bg-gray-900' style="background-color: #a0bd1c;": page.startsWith('component-') }" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('component-'))"><a class="sidebar-expander-link block text-gray-50 hover:text-white transition duration-150" :class="open && 'hover:text-gray-100'" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center"><svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="{ 'hidden': !open }" x-cloak>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-button' && '!text-indigo-500'" href="component-button.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Button</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-form' && '!text-indigo-500'" href="component-form.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Input Form</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-dropdown' && '!text-indigo-500'" href="component-dropdown.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Dropdown</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-alert' && '!text-indigo-500'" href="component-alert.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Alert & Banner</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-modal' && '!text-indigo-500'" href="component-modal.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Modal</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-pagination' && '!text-indigo-500'" href="component-pagination.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Pagination</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-tabs' && '!text-indigo-500'" href="component-tabs.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tabs</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-breadcrumb' && '!text-indigo-500'" href="component-breadcrumb.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Breadcrumb</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-badge' && '!text-indigo-500'" href="component-badge.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Badge</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-avatar' && '!text-indigo-500'" href="component-avatar.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Avatar</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-tooltip' && '!text-indigo-500'" href="component-tooltip.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tooltip</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-accordion' && '!text-indigo-500'" href="component-accordion.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Accordion</span></a></li>
                                    <li class="mb-1 last:mb-0"><a class="block text-gray-400 hover:text-gray-100 transition duration-150 truncate" :class="page === 'component-icons' && '!text-indigo-500'" href="component-icons.php"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Icons</span></a></li>
                                </ul>
                            </div>
                        </li> -->
                    </ul>
