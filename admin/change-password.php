				...
				<div class="w-full md:w-1/2">
					<div class="min-h-screen h-full flex flex-col after:flex-1">
						...
						<div class="max-w-sm mx-auto w-full px-4 py-8">
							<h1 class="text-3xl text-gray-800 font-bold mb-6">Change Password ✨</h1>
							<form action="./handler/reset_handler.php" method="post">
								<div class="space-y-4">
									<div>
										...
										<input required name="password" class="form-input w-full" type="password" autocomplete="on" />
									</div>

									<div>
										<label class="block text-sm font-medium mb-1" for="password">Confirm Password</label> 
										<input name="confirm_password" class="form-input w-full" type="password" autocomplete="on" />

                                        <span data-error class="text-red-500 text-xs block mt-2"></span>
									</div>
								</div>

								<div class="flex items-center justify-between mt-6">
									<button class="btn bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap" name="change" type="submit"> Change Password </button>
								</div>
							</form>
						</div>
					</div>
